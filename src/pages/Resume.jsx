    ...
    <div className="bg-black min-h-screen text-zinc-400 selection:bg-white selection:text-black overflow-x-hidden font-['Plus_Jakarta_Sans']">
      ...
      <main className="relative z-10 max-w-6xl mx-auto p-6 md:p-12 lg:p-16 mt-12 md:mt-0">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-auto">
          {/* PROFILE CARD */}
          <section
            className="minimal-card col-span-1 md:col-span-2 row-span-2 p-8 md:p-10 flex flex-col justify-between animate-enter"
          ...
          >
            <div className="flex justify-between items-start mb-12">
              <img
                ...
                alt="Swayam Purwar"
                className="w-16 h-16 md:w-20 md:h-20 rounded-full object-cover grayscale border border-white/10"
              />
            ...
            <div className="space-y-6 z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6 flex-wrap no-print">
                <a
                  ...
                  download
                  className="solid-btn px-6 py-3 rounded-full font-medium text-sm flex items-center justify-center gap-2"
                >
                  Download Resume
                </a>
                <div className="flex gap-3">
                  <a
                    ...
                    rel="noreferrer"
                    aria-label="GitHub"
                    className="outline-btn w-12 h-12 rounded-full flex items-center justify-center"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
          ...
          {/* TELEMETRY DASHBOARD */}
          <section
            className="minimal-card col-span-1 row-span-2 p-8 flex flex-col justify-between h-auto min-h-[380px] animate-enter"
            style={{ animationDelay: "0.2s" }}
          >
            <div className="mb-6 pb-5 border-b border-white/5">
              <h3 className="text-[10px] font-medium text-white uppercase tracking-widest mb-1.5">
                System Status
              </h3>
          ...
          {/* TECH STACK CARD */}
          <section
            className="minimal-card col-span-1 md:col-span-3 p-8 md:p-12 animate-enter"
            style={{ animationDelay: "0.3s" }}
          >
            <h3 className="text-[10px] font-medium text-white uppercase tracking-widest mb-8">
              Technical Arsenal
            </h3>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="space-y-4">
                <h4 className="text-zinc-500 text-xs uppercase tracking-widest mb-4">
                  Front-End
                </h4>
          ...
          <div
            className="col-span-1 md:col-span-3 mt-12 mb-2 animate-enter"
          ...
          <Link
            to="/work/apple-music"
            className="minimal-card col-span-1 md:col-span-1 group block animate-enter"
            style={{ animationDelay: "0.5s" }}
          >
            <article className="p-8 h-full flex flex-col justify-between">
              <div>
                <span className="text-[10px] text-zinc-500 font-mono tracking-widest mb-4 block">
                  01
                </span>
                <h3 className="text-lg font-medium text-white mb-3 group-hover:text-zinc-300 transition-colors">
                  Apple Music Clone
                </h3>
          ...
          <article
            className="minimal-card col-span-1 md:col-span-2 group block animate-enter"
          ...
          >
            <div className="p-8 h-full flex flex-col justify-between relative z-10">
              <div>
                ...
                <h3 className="text-lg font-medium text-white mb-3 group-hover:text-zinc-300 transition-colors">
                  This Portfolio Architecture
                </h3>
                <p className="text-zinc-500 text-sm leading-relaxed max-w-xl">
                  Designed from the ground up for performance and aesthetic
                  minimalism. Built entirely using React, styled purely with
                  Tailwind CSS, and optimized for seamless page transitions
                  without relying on heavy external animation libraries.
                </p>
              </div>
          ...
          {/* EXPERIENCE SECTION */}
          <section
            className="minimal-card col-span-1 md:col-span-3 p-8 md:p-12 mt-6 animate-enter"
            style={{ animationDelay: "1.0s" }}
          >
            <h3 className="text-[10px] font-medium text-white uppercase tracking-widest mb-10">
              Experience
            </h3>
          ...
          {/* CONNECT SECTION */}
          <section
            className="col-span-1 md:col-span-3 mt-12 mb-6 animate-enter"
        ...
        {/* Footer Navigation */}
        <div
          className="flex justify-center mt-12 mb-8 animate-enter"
          style={{ animationDelay: "1.3s" }}
        >
          <Link
            to="/"
            className="outline-btn px-6 py-3 rounded-full text-xs font-medium uppercase tracking-widest flex items-center gap-3 group"
          >
            <svg
