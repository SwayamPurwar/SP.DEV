...
gsap.fromTo(".cs-meta", { y: 30, opacity: 0 }, { y: 0, opacity: 1, duration: 1, ease: "power3.out", delay: 0.6, clearProps: "transform,opacity" });
  ...
  return (
    <>
      <SEO title="CodeSense AI SaaS | Case Study" description="Engineering deep dive into building an AI-powered code generation SaaS platform." />
      <div ref={containerRef} style={{ position: "relative", overflowX: "hidden" }}>
        ...
        <header className="cs-hero" style={{ paddingTop: "20vh", paddingBottom: "10vh" }}>
