...
import CaseStudyFooter from "../../components/CaseStudyFooter"; // <-- Imported the new footer
  ...
  return (
    <>
      ...
      <div ref={containerRef}>
        {/* <-- ADDED THE GRID BACKGROUND HERE --> */}
        ...
        <div className="cs-content">
          ...
          <section className="cs-section">
            ...
            <div className="cs-image">
              <img
                src="/assets/images/project/apple-music-preview.webp"
                alt="Discovery Phase"
          ...
          <section className="cs-section">
            ...
            <div
              className="cs-image wireframe-box"
          ...
          <section className="cs-section">
            <div className="cs-text glass-card">
              ...
              <p>
                The final prototype was built in Protopie to handle the complex,
                logic-based micro-interactions. The result is a player that
                feels alive, reacting to the music and the user's touch.
              </p>
            </div>
            <div className="cs-image">
              <img
        ...
        <CaseStudyFooter
          currentProject="apple-music"
          backLink="/work/apple-music"
        />
      </div>
    </>
  );
