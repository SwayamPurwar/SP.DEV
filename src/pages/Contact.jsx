...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "Network transmission failed. Please check your connection and try again.",
      );
      setIsSending(false);
    }
  };
  ...
  return (
    <>
      <SEO
        title="Contact | Swayam Purwar"
        description="Get in touch. Open for freelance opportunities and full-time roles."
      />
          ...
          <div className="lux-info-section" ref={topInfoRef}>
            <div>
              ...
              <p className="lux-subtitle">
                ...
                experiences that matter. Have a project in mind? Let's bring it
                to life.
              </p>
            </div>
            ...
            <div className="lux-details-grid">
              <div>
                ...
                <a
                  ...
                  className="lux-contact-link mouse-hover"
                >
              ...
              <div>
                ...
                <div className="lux-social-list">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="lux-social-pill mouse-hover"
                  >
                    LinkedIn
                    <svg
                      viewBox="0 0 24 24"
          ...
          <div ref={formCardRef}>
            <div className="lux-form-card">
              ...
              >
                ...
                <button
                  type="submit"
                  className="lux-submit-btn mouse-hover"
                  disabled={isSending}
                >
