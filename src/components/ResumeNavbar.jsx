...
export default function ResumeNavbar() {
  ...
  useEffect(() => {
    // Exact scroll threshold from home page
  ...
  return (
    <nav
      ...
      style={{
        zIndex: 200000,
        mixBlendMode: "normal", // Keeps it strictly visible on dark background
      }}
    >
      <Link to="/" className="logo mouse-hover" onClick={() => window.scrollTo(0, 0)}>
        SP.DEV
      </Link>
      ...
      <div className="nav-right" style={{ display: "flex", alignItems: "center" }}>
        <button
          ...
          style={{
            background: "none",
            border: "none",
            color: "#fff", // Force white color for the dark theme
            display: "flex",
            alignItems: "center",
            opacity: 0.6,
            transition: "opacity 0.3s",
            cursor: "pointer",
            padding: "0" // Clean up extra spacing
          }}
