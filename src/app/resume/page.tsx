    ...
    const handleMouseMove = (e: MouseEvent) => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          document.querySelectorAll<HTMLElement>(".minimal-card").forEach((card) => {
    ...
    <div className="resume-page">
      ...
      <main className="resume-main">
        <div className="resume-grid">
          ...
          {/* PROJECT CARDS */}
          <Link href="/work/apple-music" className="minimal-card project-card animate-enter" style={{ animationDelay: "0.5s" }}>
          ...
          <Link href="/work/instagram" className="minimal-card project-card animate-enter" style={{ animationDelay: "0.6s" }}>
            <article className="project-content">
              <div>
          ...
          <Link href="/work/CodeSenseAiSaas" className="minimal-card project-card animate-enter" style={{ animationDelay: "0.8s" }}>
            <article className="project-content">
              <div>
            ...
            <div className="project-content">
              <div>
                ...
                <p className="project-desc max-w-xl">
                  Designed from the ground up for performance and aesthetic minimalism. Built entirely using Next.js, React, and optimized for seamless page transitions.
                </p>
              </div>
