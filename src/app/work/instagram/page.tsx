...
export default function Instagram() {
  ...
  return (
    <div ref={containerRef}>
        ...
        <section className="p-hero">
          ...
          <div className="p-img-wrapper">
            <div className="p-img-container">
              <Image
                src="https://images.unsplash.com/photo-1611262588024-d12430b98920?q=80&w=1674&auto=format&fit=crop"
                className="p-img"
                alt="Instagram clone UI"
                width={1674}
                height={1116}
          ...
          <div className="p-content">
            <article className="p-desc glass-card">
              ...
              <div>
                <p>
                  Building a fully functional social media platform is a complex
                  architectural challenge. The goal was to replicate the core
                  "addictive" features of Instagram—infinite scroll, instant
                  likes, and real-time updates—within a scalable environment.
                </p>
                <p>
                  I utilized <strong>MongoDB</strong> for the robust backend to
                  handle user data schemas, while <strong>React</strong>{" "}
                  provided a snappy, app-like experience on the frontend.
                </p>
              </div>
              <div className="btn-group">
                {/* FIX: Changed relative path to absolute React Router path */}
                <Link
                  href="/work/instagram-casestudy"
      ...
      <ProjectsFooter currentProject="instagram" />
    </div>
  );
}