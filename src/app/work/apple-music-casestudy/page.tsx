...
const scrollTimer = setTimeout(() => {
  ...
  // Adding <HTMLElement> here tells TS that 'section' is an HTMLElement
  gsap.utils.toArray<HTMLElement>(".cs-section").forEach((section) => {
    gsap.fromTo(
      section, // No 'as' needed here because of the generic above
      { y: 50, opacity: 0 },
      {
        scrollTrigger: {
          trigger: section, // This will now be correctly typed as HTMLElement
          start: "top 85%",
        },
        y: 0,
        opacity: 1,
