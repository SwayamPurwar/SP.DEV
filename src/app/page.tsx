...
export default function Home() {
  ...
  const handleMouseEnter = (imgUrl: string, isSecret = false) => {
      ...
      <main style={{ perspective: "1000px" }}>
        <section id="hero">
          ...
          <div className="cv-wrapper">
            <Link href="/resume" className="cv-btn mouse-hover" data-strength="25">
  ...
  height={800}
          ...
          <div className="about-text">
            ...
            <Link href="/about" className="btn mouse-hover reveal-text" data-strength="30">
              Read More
            </Link>
          </div>
        </section>
