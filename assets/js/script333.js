...
// =========================================
// 0. MASTER INTERACTIVE LIST (The "VIP List")
// =========================================
// Any class added here will automatically get:
// 1. Magnetic Hover Effect ("Auto Magic")
// 2. Sound Effects (Hover & Click)
// 3. Custom Cursor Expansion
const interactiveSelector = [
    "a",                      // All links
    "button",                 // All buttons
    ".btn",                   // Standard buttons
    ".t-btn",                 // Kite Terminal Buttons (Buy/Sell) <--- ADDED
    ".nav-item",              // Navigation
    ".toc-link",              // Case Study Sidebar Links <--- ADDED
    ".tech-pill",             // Tech Stack Tags
    ".cv-btn",                // Resume Button
    ".cs-tag",                // Case Study Tags
    ".project-link",          // Portfolio Project Cards
    ".socials a",             // Footer Icons
    ".mouse-hover"            // Universal utility class
].join(", ");
...
if (cursor) {
    ...
    if (window.matchMedia("(pointer: fine)").matches) {
        ...
        // USE MASTER LIST FOR CURSOR EXPANSION
...
// 8. MAGNETIC BUTTONS ("Auto Magic")
// Using the Master List so everything magnetic is also sound-enabled
const magnets = document.querySelectorAll(interactiveSelector);

magnets.forEach((magnet) => {
    // Skip large cards to avoid dizzying movement
...
// 12. PROJECT PREVIEW REVEAL (Follow Cursor Exactly)
...
const blurTitle = "System Offline // Come Back"; 
...
// --- FIX: USE MASTER LIST FOR SOUNDS ---
        ...
        case "matrix":
            if (typeof window.toggleMatrix === "function") {
                ...
                window.toggleMatrix(true);
                 ...
                 printOutput("Error: Matrix Module not loaded.");
            }
            break;
        case "color":
            if (arg) {
                ...
                printOutput("Error: Please specify a color.");
            }
            break;
        case "blackout":
        case "shutdown":
...
if (closeCmdBtn) {
    closeCmdBtn.addEventListener("click", () => { toggleTerminal(); });
}

// =========================================
// 9. HOLOGRAPHIC TILT EFFECT
// =========================================
    ...
    if (e.key === "Escape") {
        ...
        if (escCount === 2) {
            ...
            if (screen.style.display === "flex") {
                ...
                document.title = "index.js - Visual Studio Code"; 
            }
            escCount = 0;
        }
    }
